class ControlPanel
  ...
  def create_route
    ...
    if correct_stations?(init_index, final_index)
  ...
  def create_train
    ...
    if type == 'cargo'
      ...
      puts "\nCargo train was created!"
    elsif type == 'passenger'
      trains << PassengerTrain.new(number)
      puts "\nPassenger train was created!"
    else
  ...
  def correct_stations?(init_station, final_station)
    correct_index?(init_station, stations) &&
    correct_index?(final_station, stations) &&
    init_station != final_station
  end
